...
class Jeopardy extends Rooms.RoomGame {
	...
	buzz(user) {
		...
		this.state = "answering";
		this.timeout = setTimeout(() => this.check(false), answeringTime * 1000);
	}
	...
	startFinals() {
		...
		this.state = "wagering";
		this.clearwagers();
		this.timeout = setTimeout(() => this.finalWagers(), finalsAnsweringTime * 1000);
	}
	...
	finalWagers() {
		...
		this.state = "answering";
		this.askQuestion();
		this.timeout = setTimeout(() => this.doFinals(), finalsAnsweringTime * 1000);
	}
